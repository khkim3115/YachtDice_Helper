...
/** 점수 desc, 동점은 먼저 등록한 순으로 상위 10개. */
export async function fetchTopScores(): Promise<LbEntry[]> {
...
/** 점수 제출(서버가 Top10 초과분 정리). */
export async function submitScore(nickname: string, score: number, mode: LbMode): Promise<void> {
